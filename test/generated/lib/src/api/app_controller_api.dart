...
class AppControllerApi {
  ...
  const AppControllerApi(this._dio, this._serializers);
  ...
  Future<Response<Message>> addMessage({ 
    ...
    try {
      const _type = FullType(Message);
      _bodyData = _serializers.serialize(message, specifiedType: _type);
