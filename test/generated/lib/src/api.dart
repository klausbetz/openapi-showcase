...
class Api {
  ...
  /// Get AppControllerApi instance, base route and serializer can be overridden by a given but be careful,
  /// by doing that all interceptors will not be executed
  AppControllerApi getAppControllerApi() {
    return AppControllerApi(dio, serializers);
  }
}
